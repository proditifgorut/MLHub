    ...
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Ruang Kerja Sains Data</h1>
          <p className="text-gray-600">Lingkungan lengkap Anda untuk eksplorasi sains data, pemodelan, dan analisis mendalam.</p>
        </motion.div>
