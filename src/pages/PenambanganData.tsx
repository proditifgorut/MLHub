...
const PenambanganData: React.FC = () => {
    ...
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Ruang Kerja Penambangan Data</h1>
          <p className="text-gray-600">Lingkungan lengkap Anda untuk penambangan data, analisis, dan pelatihan model machine learning.</p>
        </motion.div>
...
export default PenambanganData;
